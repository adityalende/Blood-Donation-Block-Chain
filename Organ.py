...
import random
pop_size = 1000
pop=random.sample(range(0,1000),1000)
pop2=[]
needs_organ=[]
pair_compatible=[]
pair_not_compatible=[]
...
while i<50:
    ...
    i+=1
print('Person who needs organ =', needs_organ)
...
print('Compatible blood groups=', pair_compatible )

print('Not compatible blood groups=', pair_not_compatible )
...
print('cross pair matched =', cross_pair_matched)
...
print('Donor pool matched =', donor_pool_matched )

print('Didn\'t received organ =', pair_not_compatible)
